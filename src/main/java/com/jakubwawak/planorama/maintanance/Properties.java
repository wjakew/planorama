 ...
 * all rights reserved
 */
package com.jakubwawak.planorama.maintanance;
...
public class Properties {
    ...
    public void createPropertiesFile() {
        try {
            ...
            writer.write("#adstats properties file\n");
            writer.write("$fileVersion=1\n");
            writer.write("#by Jakub Wawak / all rights reserved / kubawawak@gmail.com\n");
            writer.write("$database_url=mongodb://localhost:27017\n");
            writer.write("$account_creation_enabled=1\n");
            writer.write("$tenant_name=PersonalPlanorama\n");
            writer.close();
        } catch (Exception ex) {
            error = true;
